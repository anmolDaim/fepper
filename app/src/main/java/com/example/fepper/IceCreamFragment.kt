...
class IceCreamFragment : Fragment() {
    lateinit var iceCreamRecyclerView: RecyclerView

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_ice_cream, container, false)
        iceCreamRecyclerView=view.findViewById(R.id.iceCreamRecyclerView)
        return view
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        iceCreamRecyclerView.layoutManager = layoutManager
