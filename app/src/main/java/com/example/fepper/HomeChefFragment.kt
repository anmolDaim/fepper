...
class HomeChefFragment : Fragment() {
    lateinit var homeCheftRecyclerView: RecyclerView

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_home_chef, container, false)
        homeCheftRecyclerView=view.findViewById(R.id.homeCheftRecyclerView)
        return view
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homeCheftRecyclerView.layoutManager = layoutManager
        val adapter = itemsAdapter(requireContext(),itemArr)
        homeCheftRecyclerView.adapter = adapter
    }
